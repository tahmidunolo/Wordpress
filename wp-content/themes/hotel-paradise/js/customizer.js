( function( api ) {
    ...
    api.sectionConstructor['hotel_paradise-plus'] = api.Section.extend( {
		...
		_init: function() {
            ...
            control.actions = function ($context) {
                if (control.params.live_title_id) {
                    ...
                    if (control.id === 'hotel_paradise_section_order_styling') {
    ...
    function _the_editor( container ){
        var _editor = {
            ...
            ready: function( container ) {
                ...
                control.container.addClass( 'hotel_paradise-editor-added' );
...
jQuery( window ).ready( function( $ ){
    ...
    if ( typeof hotel_paradise_customizer_settings !== "undefined" ) {
        if (hotel_paradise_customizer_settings.number_action > 0) {
            $('.control-section-themes h3.accordion-section-title').append('<a class="theme-action-count" href="' + hotel_paradise_customizer_settings.action_url + '">' + hotel_paradise_customizer_settings.number_action + '</a>');
        }
    }
     ...
     */
    $( 'select[data-customize-setting-link="hotel_paradise_hero_layout"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';

        $( "li[id^='customize-control-hotel_paradise_hcl']").hide();
        $( "li[id^='customize-control-hotel_paradise_hcl"+v+"']").show();

    } );
    $( 'select[data-customize-setting-link="hotel_paradise_hero_layout"]').trigger( 'on_custom_load' );


    /**
     * For Gallery content settings
     */
    $( 'select[data-customize-setting-link="hotel_paradise_gallery_source"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';

        $( "li[id^='customize-control-hotel_paradise_gallery_source_']").hide();
        $( "li[id^='customize-control-hotel_paradise_gallery_api_']").hide();
        $( "li[id^='customize-control-hotel_paradise_gallery_settings_']").hide();
        $( "li[id^='customize-control-hotel_paradise_gallery_source_"+v+"']").show();
        $( "li[id^='customize-control-hotel_paradise_gallery_api_"+v+"']").show();
        $( "li[id^='customize-control-hotel_paradise_gallery_settings_"+v+"']").show();

    } );

    $( 'select[data-customize-setting-link="hotel_paradise_gallery_source"]').trigger( 'on_custom_load' );

    /**
     * For Gallery display settings
     */
    $( 'select[data-customize-setting-link="hotel_paradise_gallery_display"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';
        switch ( v ) {
            case 'slider':
                $( "#customize-control-hotel_paradise_g_row_height, #customize-control-hotel_paradise_g_col, #customize-control-hotel_paradise_g_spacing").hide();
                break;
            case 'justified':
                $( "#customize-control-hotel_paradise_g_col, #customize-control-hotel_paradise_g_spacing").hide();
                $( "#customize-control-hotel_paradise_g_row_height").show();
                break;
            case 'carousel':
                $( "#customize-control-hotel_paradise_g_row_height, #customize-control-hotel_paradise_g_col").hide();
                $( "#customize-control-hotel_paradise_g_col, #customize-control-hotel_paradise_g_spacing").show();
                break;
            case 'masonry':
                $( "#customize-control-hotel_paradise_g_row_height").hide();
                $( "#customize-control-hotel_paradise_g_col, #customize-control-hotel_paradise_g_spacing").show();
                break;
            default:
                $( "#customize-control-hotel_paradise_g_row_height").hide();
    ...
    $( 'select[data-customize-setting-link="hotel_paradise_gallery_display"]').trigger( 'on_custom_load' );
