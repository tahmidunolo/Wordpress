<?php 
function Hotel_Paradise_page_menu_args( $args ) {
	if ( ! isset( $args['show_home'] ) )
		$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'Hotel_Paradise_page_menu_args' );

 
function Hotel_Paradise_fallback_page_menu( $args = array() ) {
	...
	$list_args['title_li'] = '';
	$list_args['walker'] = new Hotel_Paradise_walker_page_menu;
...
class Hotel_Paradise_walker_page_menu extends Walker_Page{
