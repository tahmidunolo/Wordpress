...
{name: "transparent-header-background-color", selector: ".body-wrapper.gdlr-header-transparent .gdlr-header-inner-overlay{ background-color: #gdlr#; }"},
...
{name: "main-navigation-text-hover-divider", selector: ".gdlr-navigation-gimmick{ background-color: #gdlr#; } .gdlr-menu-search-button-sep{ color: #gdlr#; }"},
{name: "main-navigation-search-button", selector: ".gdlr-navigation-wrapper .gdlr-menu-search-button{ color: #gdlr#; }"},
{name: "header-social-icon-color", selector: ".top-social-wrapper .social-icon a{ color: #gdlr#; }"},
{name: "header-social-icon-hover-color", selector: ".top-social-wrapper .social-icon a:hover{ color: #gdlr#; }"},
{name: "transparent-main-navigation-text", selector: ".gdlr-header-transparent .gdlr-main-menu > li > a{ color: #gdlr#; }"},
{name: "transparent-main-navigation-text-hover", selector: ".gdlr-header-transparent .gdlr-main-menu > li:hover > a, .gdlr-header-transparent .gdlr-main-menu > li.current-menu-item > a, .gdlr-header-transparent .gdlr-main-menu > li.current-menu-ancestor > a{ color: #gdlr#; }"},
...
{name: "page-title-color", selector: ".gdlr-page-title, .gdlr-page-title-gimmick{ color: #gdlr#; }body .gdlr-page-title-vertical-divider{ border-color: #gdlr#; }"},
{name: "page-caption-color", selector: ".gdlr-page-caption, .gdlr-page-caption .blog-info i, .gdlr-page-caption .blog-info a{ color: #gdlr#; }"},
...
{name: "blog-share-icon", selector: ".gdlr-social-share.gdlr-type-fa a, .gdlr-social-share.gdlr-type-fa a:hover{ color: #gdlr#; }"},
...
{name: "portfolio-thumbnail-hover-background", selector: ".gdlr-image-link-shortcode .gdlr-image-link-overlay, .gdlr-room-category-thumbnail-overlay, .portfolio-thumbnail .portfolio-overlay{ background-color: #gdlr#; }"},
{name: "portfolio-thumbnail-hover-icon", selector: ".gdlr-image-link-shortcode .gdlr-image-link-icon, .gdlr-room-category-thumbnail-overlay-icon i, .portfolio-thumbnail .portfolio-icon i{ color: #gdlr#; }"},
...
{name: "single-room-title-color", selector: ".single .gdlr-room-title{ color: #gdlr#; }"},
{name: "single-room-info-background", selector: ".single .gdlr-room-info{ background-color: #gdlr#; }"},
{name: "single-room-info-color", selector: ".single .gdlr-room-info{ color: #gdlr#; }"},
...
{name: "room-price-color", selector: ".single .gdlr-room-price .gdlr-tail, .gdlr-classic-room .gdlr-room-price .gdlr-tail,.gdlr-medium-room .gdlr-room-price .gdlr-tail, .gdlr-room-service-unit{ color: #gdlr#; }"},
{name: "modern-room-detail-color", selector: ".gdlr-modern-room .gdlr-room-detail{ color: #gdlr#; }"},
{name: "modern-new-room-thumbnai-overlay-color", selector: ".gdlr-modern-room-new .gdlr-room-thumbnail-overlay{ background: #gdlr#; background: rgba(#gdlra#, 0.85); }"},
...
{name: "booking-summary-text-color", selector: ".gdlr-reservation-bar .gdlr-price-summary-wrapper, .gdlr-price-summary-grand-total.gdlr-active, .gdlr-price-deposit-wrapper .gdlr-price-deposit-input span.gdlr-active{ color: #gdlr#; }.gdlr-price-deposit-input .gdlr-radio-input { background: #gdlr#; }.gdlr-price-deposit-input .gdlr-radio-input { border: 3px solid #gdlr# !important; }"},
{name: "booking-summary-info-color", selector: ".gdlr-price-summary-grand-total, .gdlr-service-price-summary-item, .gdlr-reservation-bar .gdlr-price-room-summary, .gdlr-reservation-bar .gdlr-price-room-summary-info, .gdlr-price-deposit-wrapper .gdlr-price-deposit-caption, .gdlr-price-deposit-wrapper .gdlr-price-deposit-input span{ color: #gdlr#; }"},
...
{name: "booking-complete-message-title", selector: ".gdlr-booking-failed .gdlr-booking-failed-title, .gdlr-booking-complete .gdlr-booking-complete-title, .gdlr-booking-service-head, .gdlr-room-service-title, .gdlr-booking-complete .gdlr-booking-complete-additional i, .gdlr-room-selection-complete .gdlr-room-selection-title{ color: #gdlr#; }"},
{name: "checkbox-text-color-new", selector: "body.hotelmaster-new-style .gdlr-price-deposit-input .gdlr-radio-input, body.hotelmaster-new-style .gdlr-room-service-checkbox{ color: #gdlr#; }"},
{name: "checkbox-background-color-new", selector: "body.hotelmaster-new-style .gdlr-price-deposit-input .gdlr-radio-input, body.hotelmaster-new-style .gdlr-room-service-checkbox{ background-color: #gdlr#; }"},
{name: "checkbox-background-active-color-new", selector: "body.hotelmaster-new-style .gdlr-price-deposit-input .gdlr-active .gdlr-radio-input, body.hotelmaster-new-style .gdlr-room-service-checkbox.gdlr-active{ background-color: #gdlr#; }"},
...
{name: "booking-process-text-active", selector: ".gdlr-booking-process-bar .gdlr-active{ color: #gdlr#; }"},
{name: "booking-process-text", selector: ".gdlr-booking-process-bar{ color: #gdlr#; }"},
{name: "booking-process-border", selector: ".gdlr-booking-process-bar .gdlr-booking-process:before, body.hotelmaster-new-style .gdlr-booking-process-bar{ border-left-color: #gdlr#; }"},
{name: "reservation-bar-background", selector: ".gdlr-reservation-bar{ background-color: #gdlr#; }"},
{name: "reservation-bar-header-text", selector: ".gdlr-reservation-bar .gdlr-reservation-bar-title, body.hotelmaster-v4-style .gdlr-reservation-bar-head-price .gdlr-tail{ color: #gdlr#; }"},
{name: "reservation-bar-header-border", selector: ".gdlr-reservation-bar .gdlr-reservation-bar-title{ border-color: #gdlr#; }"},
{name: "reservation-bar-input-title", selector: ".gdlr-reservation-bar .gdlr-reservation-field-title, .gdlr-reservation-people-title, .gdlr-reservation-time-title, .gdlr-reservation-time-sep { color: #gdlr#; }"},
{name: "reservation-bar-input-background", selector: ".gdlr-reservation-bar input.gdlr-datepicker, .gdlr-reservation-bar .gdlr-combobox-wrapper select, .gdlr-reservation-bar .gdlr-combobox-wrapper select option, .gdlr-reservation-bar .gdlr-combobox-wrapper{ background-color: #gdlr#; }"},
{name: "reservation-bar-input-border", selector: "body.hotelmaster-new-style .gdlr-reservation-bar .gdlr-combobox-wrapper, body.hotelmaster-new-style .gdlr-reservation-bar input.gdlr-datepicker, body.hotelmaster-v4-style .gdlr-reservation-bar *, .gdlr-hotel-availability-wrapper.gdlr-style-v4 .gdlr-reservation-field{ border-color: #gdlr#; }"},
{name: "reservation-bar-input-text", selector: ".gdlr-reservation-bar input.gdlr-datepicker, .gdlr-reservation-bar .gdlr-combobox-wrapper select{ color: #gdlr#; }.hotelmaster-v4-style .gdlr-reservation-field.gdlr-resv-datepicker .gdlr-reservation-field-title, .hotelmaster-v4-style .gdlr-reservation-people-amount .gdlr-reservation-field.gdlr-resv-combobox .gdlr-reservation-field-title, .hotelmaster-v4-style .gdlr-reservation-field.gdlr-resv-night .gdlr-reservation-field-title, .hotelmaster-v4-style .gdlr-reservation-field .gdlr-reservation-time-title, .gdlr-hotel-availability-wrapper.gdlr-style-v4 .gdlr-reservation-field-title{ color: #gdlr#; }"},
...
{name: "reservation-bar-room-section-text-title", selector: ".gdlr-reservation-room .gdlr-reservation-room-title{ color: #gdlr#; }"},
{name: "reservation-bar-room-section-text", selector: ".gdlr-reservation-room{ color: #gdlr#; }"},
{name: "reservation-bar-room-section-active-title", selector: ".gdlr-reservation-room.gdlr-active .gdlr-reservation-room-title{ color: #gdlr#; }"},
{name: "reservation-bar-room-section-active-text", selector: ".gdlr-reservation-room.gdlr-active .gdlr-reservation-room-info{ color: #gdlr#; }"},
...
{name: "reservation-bar-branch-background", selector: ".gdlr-price-summary-hotel-branches{ background-color: #gdlr#; }"},
{name: "reservation-bar-branch-text", selector: ".gdlr-price-summary-hotel-branches{ color: #gdlr#; }"},
...
{name: "testimonial-quote-color", selector: ".gdlr-testimonial-item.plain-style2 .testimonial-item:before{ color: #gdlr#; }"},
...
{name: "input-box-background", selector: "input[type=\"text\"], input[type=\"email\"], input[type=\"password\"], textarea, .gdlr-hotel-availability .gdlr-combobox-wrapper, .gdlr-payment-form div#card-element{ background-color: #gdlr#; }"},
