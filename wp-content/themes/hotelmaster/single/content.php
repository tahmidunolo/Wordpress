<?php
	if( in_array(get_post_format(), array('aside', 'link', 'quote')) ){
		...
		}else if( strpos($gdlr_post_settings['blog-style'], 'blog-widget-2') !== false ){
			get_template_part('single/content-widget-2');
		}else if( strpos($gdlr_post_settings['blog-style'], 'blog-widget') !== false ){
			get_template_part('single/content-widget');
		}else if(strpos($gdlr_post_settings['blog-style'], 'blog2-') !== false){
			get_template_part('single/content-grid2');
		}else{
