<?php
	...
	*/
	...
	add_filter('body_class','gdlr_header_style_class');
	if( !function_exists('gdlr_header_style_class') ){
		function gdlr_header_style_class($classes) {
			global $theme_option;
			$classes[] = empty($theme_option['button-style'])? ' hotelmaster-button-classic-style': ' hotelmaster-button-' . $theme_option['button-style'];
			$classes[] = empty($theme_option['header-style'])? ' header-style-1': ' ' . $theme_option['header-style'];
			$classes[] = empty($theme_option['hotel-style'])? ' hotelmaster-classic-style': ' hotelmaster-' . $theme_option['hotel-style'];
			$classes[] = empty($theme_option['hotel-single-style'])? ' hotelmaster-single-classic-style': ' hotelmaster-single-' . $theme_option['hotel-single-style'];
			return $classes;
		}	
	}
...
<?php			
		...
		function gdlr_get_default_admin_option() {
			...
			if(empty($sidebar_option)){
				update_option('gdlr_sidebar_name', 
					array( 'blog', 'blog-left', 'portfolio', 'portfolio-left', 'shortcodes',  'woocommerce',  'Features', 'Archives', 'contact', 'single-room', 'room')
				);
			}
			
			$google_font_list = get_option(THEME_SHORT_NAME . '_google_font_list', array());
			if( empty($google_font_list) ){
				$font_text  = 'a:3:{s:9:"Open Sans";a:2:{s:7:"subsets";a:7:{i:0;s:5:"greek";i:1;s:12:"cyrillic-ext";i:2;s:8:"cyrillic";i:3;s:5:"latin";i:4;s:9:"latin-ext";i:5;s:10:"vietnamese";i:6;s:9:"greek-ext";}s:8:"variants";a:10:{i:0;s:3:"300";i:1;s:9:"300italic";i:2;s:7:"regular";i:3;s:6:"italic";i:4;s:3:"600";i:5;s:9:"600italic";i:6;s:3:"700";i:7;s:9:"700italic";i:8;s:3:"800";i:9;s:9:"800italic";}}s:12:"Merriweather";a:2:{s:7:"subsets";a:2:{i:0;s:5:"latin";i:1;s:9:"latin-ext";}s:8:"variants";a:8:{i:0;s:3:"300";i:1;s:9:"300italic";i:2;s:7:"regular";i:3;s:6:"italic";i:4;s:3:"700";i:5;s:9:"700italic";i:6;s:3:"900";i:7;s:9:"900italic";}}s:11:"Droid Serif";a:2:{s:7:"subsets";a:1:{i:0;s:5:"latin";}s:8:"variants";a:4:{i:0;s:7:"regular";i:1;s:6:"italic";i:2;s:3:"700";i:3;s:9:"700italic";}}}';
	...
	if( !function_exists('gdlr_excerpt_more') ){
		function gdlr_excerpt_more( $more ) {
			global $gdlr_excerpt_read_more, $gdlr_excerpt_word; if( !$gdlr_excerpt_read_more ) return '...';
			
			$gdlr_excerpt_word = empty($gdlr_excerpt_word)? __( 'Continue Reading', 'gdlr_translate' ): $gdlr_excerpt_word;
			return '... <div class="clear"></div><a href="' . get_permalink() . '" class="excerpt-read-more">' . 
				$gdlr_excerpt_word . '<i class="fa fa-long-arrow-right icon-long-arrow-right"></i></a>';
		}
	}
