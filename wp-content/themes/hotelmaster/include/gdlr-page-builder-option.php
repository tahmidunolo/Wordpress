	...
	*/
	...
	if( !function_exists('gdlr_page_builder_title_option') ){
		function gdlr_page_builder_title_option( $read_more = false ) {
			...
			if( $read_more ){
				$read_more_text = ($read_more === true)? __('Read All News', 'gdlr_translate'): $read_more;
				
				$title['right-text'] = array(	
					'title'=> __('Title Link Text' ,'gdlr_translate'),
					'type'=> 'text',
					'default'=> $read_more_text,
					'wrapper-class'=>'title-type-wrapper left-wrapper center-wrapper left-divider-wrapper center-divider-wrapper'
				);	
								...
								'blog' => array(
									...
									'options'=> array_merge(gdlr_page_builder_title_option(true), array(										
										...
										'blog-layout'=> array(
											...
											'wrapper-class'=> 'blog-1-4-wrapper blog-1-3-wrapper blog-1-2-wrapper blog2-1-4-wrapper blog2-1-3-wrapper blog2-1-2-wrapper blog-style-wrapper',
										...
										'thumbnail-size'=> array(
											...
											'wrapper-class'=> 'blog-1-4-wrapper blog-1-3-wrapper blog-1-2-wrapper blog2-1-4-wrapper blog2-1-3-wrapper blog2-1-2-wrapper blog-style-wrapper blog-full-wrapper blog-medium-wrapper',
								...
								'column-service' => array(
									...
									'options'=>array(
										...
										'style'=> array(
											...
											'type'=> 'combobox',
											'options'=> array(
												'type-1'=> __('Left Align' ,'gdlr_translate'),	
												'type-2'=> __('Center Align ( Round Icon )' ,'gdlr_translate'),	
												'type-3'=> __('Center Align ( Round Thumbnail/Plain Icon )' ,'gdlr_translate'),	
											)
										),										
										'content'=> array(
											'title'=> __('Content Text' ,'gdlr_translate'),
									...
									'options'=> array_merge(gdlr_page_builder_title_option(true), array(
										...
										'page-style'=> array(
											...
											'options'=> array(
												...
												'hotel' => __('Hotel Style', 'gdlr_translate'),
											),
										),	
										'item-size'=> array(
									...
									'options'=> array_merge(array(
										...
										'testimonial-style'=> array(
											...
											'options'=> array(
												...
												'plain-style2'=>__('Large Plain Style 2', 'gdlr_translate'),
											)
										),		
										'margin-bottom' => array(
											'title' => __('Margin Bottom', 'gdlr_translate'),
							...
							'options' => array(
								...
								'gallery' => array(
									...
									'options'=> array_merge(array(								
										...
										'with-featured'=> array(
											'title'=> __('With Featured' ,'gdlr_translate'),
											'type'=> 'checkbox',
								...
								'video' => array(
									...
									'options'=>array_merge(gdlr_page_builder_title_option(), array(
										...
										'content-title'=> array(
											'title'=> __('Title Text' ,'gdlr_translate'),
											'type'=> 'text',						
										),									
										'content'=> array(
											'title'=> __('Content Text' ,'gdlr_translate'),
