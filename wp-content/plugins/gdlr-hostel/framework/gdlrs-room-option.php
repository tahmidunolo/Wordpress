					...
					'page-layout' => array(
						...
						'options' => array(
							...
							'page-title-top-padding' => array(
								'title' => __('Page Title Top Padding', 'gdlr-hostel'),
								'type' => 'text',
							),
							'page-title-bottom-padding' => array(
								'title' => __('Page Title Bottom Padding', 'gdlr-hostel'),
								'type' => 'text',
							),
							'content-top-space' => array(
								'title' => __('Content Top Space' , 'gdlr-hostel'),
								'type' => 'checkbox',
								'default' => 'enable'
							),								
							'content-bottom-space' => array(
								'title' => __('Content Bottom Space' , 'gdlr-hostel'),
								'type' => 'checkbox',
								'default' => 'enable'
							),				
						)
					...
					'page-option' => array(
						...
						'options' => array(
							...
							'block-room-date' => array(
								'title' => __('Block room on specific date' , 'gdlr-hostel'),
								'type' => 'textarea',
							...
							'room-image-top-info' => array(
								'title' => __('Room Image Top Info', 'gdlr-hostel'),
								'type' => 'text',
								'description' => __('Only For Room Item With Image Style', 'gdlr-hostel')
							),
							'room-image-bottom-info' => array(
								'title' => __('Room Image Bottom Info', 'gdlr-hostel'),
								'type' => 'text',
								'description' => __('Only For Room Item With Image Style', 'gdlr-hostel')
							),
							...
							'consecutive-night-discount' => array(
								'title' => __('Discount For Consecutive Nights', 'gdlr-hostel'),
								'type' => 'cnd',
							...
							'thumbnail-type' => array(
								...
								'options' => array(
									...
									'gallery'=> __('Gallery', 'gdlr-hostel')
								),
							...
							'thumbnail-slider' => array(
								...
								'type' => 'slider',
								'wrapper-class' => 'slider-wrapper gallery-wrapper thumbnail-type-wrapper'
							),								
				...
				'options'=>array_merge(gdlr_page_builder_title_option(__('View all rooms', 'gdlr-hostel')), array(					
					...
					'room-style'=> array(
						...
						'options'=> array(
							...
							'image' => __('Image', 'gdlr-hostel'),
							'image-no-space' => __('Image No Space', 'gdlr-hostel'),
						),
					),
