					...
					'page-layout' => array(
						...
						'options' => array(
							...
							'page-title-top-padding' => array(
								'title' => __('Page Title Top Padding', 'gdlr-hotel'),
								'type' => 'text',
							),
							'page-title-bottom-padding' => array(
								'title' => __('Page Title Bottom Padding', 'gdlr-hotel'),
								'type' => 'text',
							),						
							'content-top-space' => array(
								'title' => __('Content Top Space' , 'gdlr-hotel'),
								'type' => 'checkbox',
								'default' => 'enable'
							),								
							'content-bottom-space' => array(
								'title' => __('Content Bottom Space' , 'gdlr-hotel'),
								'type' => 'checkbox',
								'default' => 'enable'
							),					
						)
					...
					'page-option' => array(
						...
						'options' => array(
							...
							'room-image-top-info' => array(
								'title' => __('Room Image Top Info', 'gdlr-hotel'),
								'type' => 'text',
								'description' => __('Only For Room Item With Image Style', 'gdlr-hotel')
							),
							'room-image-bottom-info' => array(
								'title' => __('Room Image Bottom Info', 'gdlr-hotel'),
								'type' => 'text',
								'description' => __('Only For Room Item With Image Style', 'gdlr-hotel')
							),
				...
				'options'=>array_merge(gdlr_page_builder_title_option(__('View all rooms', 'gdlr-hotel')), array(					
					...
					'room-style'=> array(
						...
						'options'=> array(
							...
							'image' => __('Image', 'gdlr-hotel'),
							'image-no-space' => __('Image No Space', 'gdlr-hotel'),
						),
					),
